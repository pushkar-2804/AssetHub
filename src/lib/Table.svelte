<script>
  ...
  <div
	class="mt-10 pt-10 w-full max-w-xl p-5 mx-auto rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-1500/ backdrop-blur-lg"
  >
	<div class="flex items-center justify-between mb-4">
	  <div class="space-y-1">
		<h2 class="text-xl font-semibold">List of All Assets</h2>
	...
	<table class="min-w-full divide-y divide-gray-200">
	  ...
	  <tbody class="bg-white divide-y divide-gray-200">
		{#each data as data1 (data1.id)}
		  <tr>
			<td class="px-6 py-4 whitespace-nowrap">{data1.name}</td>
			<td class="px-6 py-4 whitespace-nowrap">{data1.description}</td>
			<td class="px-6 py-4 whitespace-nowrap">{data1.price}</td>
			<td class="px-6 py-4 whitespace-nowrap">{data1.category}</td>
			<td class="px-6 py-4 whitespace-nowrap">{data1.image}</td>
			<td class="px-6 py-4 whitespace-nowrap">

				<button class="bg-blue-500 hover:bg-gray-700 text-white font-bold mt-5 ml-2 px-2 rounded " on:click={() => handleAddToCart(data1.id)}>Add to Cart</button>
            	<button class="bg-blue-500 hover:bg-gray-700 text-white font-bold mt-5 ml-2 px-2 rounded " on:click={() => handleViewAsset(data1)}>View Asset</button>
