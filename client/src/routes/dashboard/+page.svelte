...
<div class="flex flex-col w-full bg-white dark:bg-gray-900">
  <div class="flex">
    <div class="flex flex-row w-full font-medium justify-end p-6  bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="py-2 px-3">
        <a href="/my-assets" class="mx-1.5 py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">My Assets</a>
      </div>
      <div class="py-2 px-3">
