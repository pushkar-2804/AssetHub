  ...
  <div class="py-5 w-4/5">
      <div class="flex flex-col w-full rounded-lg align-middle bg-white">
          <div class="flex rounded-lg py-1.5 justify-Left w-full">
              <p class="mt-1 mb-4 mx-5 text-[2.5rem] font-bold leading-[4rem] tracking-tight text-black">Connect Your Wallet:</p>
          </div>
              {#if !$submitMail}
              <div class="mt-4 flex items-center justify-center gap-8 font-medium">
                ...
                <form on:submit|preventDefault={handleSubmit}>
                  <div class="mb-4">
                    ...
                    <input class="w-full px-3 py-2 border rounded" type="email" id="email" bind:value={$neucronMail} required />
                  </div>
                  <div class="mb-4">
                    <label class="block text-gray-700 mb-2" for="password">Password</label>
                    <input class="w-full px-3 py-2 border rounded" type="password" id="password" bind:value={$neucronPassword} required />
                  </div>
                  <div class="mb-4">
                  <button class="w-full mb-4 p-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">Login</button>
                </div>
                </form>
                </div>
                ...
                <div class="flex items-center justify-center">
                    ...
                    <div class="flex basis-1/2 justify-center p-8">
                        <button on:click={connectWallet} class="inline-flex text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Connect Wallet</button>
                    </div>
